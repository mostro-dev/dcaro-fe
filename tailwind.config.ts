  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'h1': ['20px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '500' }],
        // Caro_H2: Montserrat Medium, 16px
        'h2': ['16px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '500' }],
        // Caro_H3: Montserrat Regular, 15px
        'h3': ['15px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '400' }],
        // Caro_Regular: Montserrat Regular, 15px
        'regular': ['15px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '400' }],
        // Caro_Small: Jura Regular, 11px
        'small': ['12px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '400' }],
        // Caro_Xsmall: Jura Regular, 7px
        'xsmall': ['10px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '400' }],
      },
    },
  },
  plugins: [],
